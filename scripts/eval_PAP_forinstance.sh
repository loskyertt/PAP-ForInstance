...
MODEL_CHECKPOINT='./logs/log_forinstance_hproto_balanced/log_proto_forinstance_S0_N2_K1_Att1_HProto_B3_W0.05_BLoss_M5.0'
...
args=(--phase 'protoeval' --dataset "${DATASET}" --cvfold $SPLIT
      ...
      --use_balanced_loss --balanced_loss_max_weight $BALANCED_LOSS_MAX_WEIGHT)
